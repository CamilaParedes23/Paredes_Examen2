          ...
          <div className="fade-in">
            ...
            <Card className="card-custom mb-4">
              ...
              <Card.Body className="filters-container">
                <Row className="g-3">
                  <Col md={6} lg={3}>
                    <Form.Label className="form-label-custom">Búsqueda</Form.Label>
                    <Form.Control
                      type="text"
                  ...
                  <Col md={6} lg={2}>
                    <Form.Label className="form-label-custom">Moneda</Form.Label>
                    <Form.Select
                  ...
                  <Col md={6} lg={2}>
                    <Form.Label className="form-label-custom">Monto Mín.</Form.Label>
                    <Form.Control
                      type="number"
                      placeholder="0.00"
                  ...
                  <Col md={6} lg={2}>
                    <Form.Label className="form-label-custom">Monto Máx.</Form.Label>
                    <Form.Control
                      type="number"
                ...
                <Row className="mt-3">
                  <Col md={6}>
                    <Form.Label className="form-label-custom">Fecha Desde</Form.Label>
                    <Form.Control
                      type="datetime-local"
                      value={filters.from}
                  ...
                  <Col md={6}>
                    <Form.Label className="form-label-custom">Fecha Hasta</Form.Label>
                    <Form.Control
                      type="datetime-local"
                      value={filters.to}
              ...
              <Card.Body className="p-0">
                {orders.length === 0 ? (
                  <div className="text-center py-5">
                    <p className="text-muted mb-0">No se encontraron órdenes de compra</p>
                    <small className="text-muted">Intenta ajustar los filtros o crear una nueva orden</small>
                  </div>
                ) : (
                      ...
                      <tbody>
                        {orders.map((order) => (
                          <tr key={order.id}>
                            ...
                            <td className="text-truncate-custom">{order.supplierName}</td>
                            <td>
                            ...
                            <td>{new Date(order.expectedDeliveryDate).toLocaleDateString('es-ES')}</td>
                            <td>
